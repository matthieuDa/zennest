      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-24">
          <div className="col-span-1 md:col-span-2 space-y-8">
            <Link href="/" className="text-3xl font-bold tracking-tighter block hover:opacity-70 transition-opacity">
              ZenNest.
            </Link>
          ...
          <div>
            ...
            <a href="mailto:bonjour@zennest.com" className="text-black text-sm font-medium hover:underline decoration-stone-300 underline-offset-4">
              bonjour@zennest.com
            </a>
